...
var ThumbnailList = function (_a) {
    var currentPage = _a.currentPage, doc = _a.doc, labels = _a.labels, pageHeight = _a.pageHeight, pageWidth = _a.pageWidth, renderCurrentPageLabel = _a.renderCurrentPageLabel, rotation = _a.rotation, onJumpToPage = _a.onJumpToPage;
...
var ThumbnailListWithStore = function (_a) {
    ...
    return currentDoc ? (React__namespace.createElement(ThumbnailList, { currentPage: currentPage, doc: currentDoc, labels: labels, pageHeight: pageHeight, pageWidth: pageWidth, renderCurrentPageLabel: renderCurrentPageLabel, rotation: rotation, onJumpToPage: jump })) : (React__namespace.createElement("div", { className: "rpv-thumbnail__loader" },
        React__namespace.createElement(core.Spinner, null)));
};
