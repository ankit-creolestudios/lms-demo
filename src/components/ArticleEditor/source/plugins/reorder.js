...
ArticleEditor.add('plugin', 'reorder', {
    ...
    _sortable: function () {
        ...
        this.$btn.on(
            'mousedown.' + this.prefix + '-reorder touchstart.' + this.prefix + '-reorder',
    ...
    _press: function (e) {
        ...
        if (e && e.target && $target.hasClass(this.prefix + '-handle')) {
            ...
            this.$win.on(
                'mouseup.' + this.prefix + '-reorder touchend.' + this.prefix + '-reorder',
                this._release.bind(this)
            );
            this.$win.on(
                'mousemove.' + this.prefix + '-reorder touchmove.' + this.prefix + '-reorder',
