...
ArticleEditor.add('plugin', 'imageresize', {
    ...
    _press: function (e) {
        ...
        this.app.editor
            .getDoc()
            .on(
                'mousemove.' + this.prefix + '.image-resize touchmove.' + this.prefix + '.image-resize',
                this._move.bind(this)
            );
        this.app.editor
            .getDoc()
            .on(
                'mouseup.' + this.prefix + '.image-resize touchend.' + this.prefix + '.image-resize',
    ...
    _remove: function () {
        this.app.editor
            .getLayout()
            .find('#' + this.prefix + '-image-resizer')
            .remove();
    },
