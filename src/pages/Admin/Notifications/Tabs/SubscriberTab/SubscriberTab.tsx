...
class SubscriberTab extends Component<IProps, IState> {
        ...
        return (
            ...
            >
                <ApiTable
                    ...
                    basePath='/admin/notifications/mailingList/edit/subscribers'
                    apiCall={{
                        method: 'GET',
                        path: `/mailingList/subscribers/${mailingListId}`,
                    }}
                    columns={[
                        {
                            text: 'First Name',
...
export default withContext(SubscriberTab, NotificationContext);
