    ...
    loadSubItemsData = async () => {
        const { success, response } = await apiCall(
            ...
            this.props.match.params.coreId
                ? `/core/lessons/chapter/${this.props.item._id}`
                : `/courses/lessons/chapter/${this.props.item._id}`
        );
                        ...
                        {pageStatus === 'READY' &&
                            subItems.map((lesson) => (
                                <Link
                                    ...
                                    to={
                                        params.coreId
                                            ? `/admin/core-library/${params.coreId}/chapters/${params.chapterId}/lessons/${lesson._id}`
                                            : `/admin/courses/${params.courseId}/chapters/${lesson.chapterId}/lessons/${lesson._id}`
                                    }
                                    className={`lfmenu-subitem${
                                        params.lessonId === lesson._id ? ' lfmenu-subitem__active' : ''
                                    }`}
                                >
                                    {lesson.title}
                                </Link>
