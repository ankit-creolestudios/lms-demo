...
class BooleanAnswer extends Component {
    ...
    getOptionIndex = (QuestionIndex, optionPosition) => {
    ...
    getSelectedOptionIndex = (questionIndex) => {
    ...
    render() {
        ...
        return (
            <div className='boolean-answer-card-component'>
                <header>
